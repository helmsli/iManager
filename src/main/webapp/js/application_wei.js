...
App.controller('application_public', function($scope){
    ...
    $scope.saveApplication = function ()
    {
    	...
    	var alldata={"pName":$scope.application.projectName,
    			     ...
    			     "addressCode":$scope.application.registerAddressCode,
    			     "serviceAddress":$scope.application.registerAddress,
    			     "serviceAddressCode":$scope.application.registerAddressCode,
    	...
    	var obj={	   
    			...
    			"request.serviceOwner":$scope.application.registerAddressCode,    			
    			"request.data1":$scope.application.registerAddress,
    			"request.data2":$scope.application.amount,
    			"request.data3":$scope.application.companyName,
    			"request.data4":$scope.application.comType,
	  		...
	  		if(data.result == 0){
	  			...
	  			setTimeout(function () {
	  				$scope.$apply(function() {
	  					...
	  					$scope.application.registerAddressCode=commonbiz.serviceOwner;
	  					$scope.application.registerAddress=commonbiz.data1;
	  					$scope.application.amount=commonbiz.data2;
	  					$scope.application.companyName=commonbiz.data3;
	  					$scope.application.comType=commonbiz.data4;
...
function downloadApplicationTemplate()
{
	...
	//alert("click");
     ...
     url= getBasePath()+url;
     url=url+"?request.annexName="+"canlian_application_wei.docx";
    // console.log(url);
     location.href =url;
}
